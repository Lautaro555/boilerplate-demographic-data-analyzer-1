...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = df= pd.read_csv("adult.data.csv", sep=",", decimal=".")
    ...
    higher_education_rich = round(df[(df["salary"]== ">50K")&((df["education"]=="Bachelors")|(df["education"]=="Masters")|(df["education"]=="Doctorate"))]["education"].count()/higher_education*100,1)
    ...
    highest_earning_country_percentage = float(round(df[(df["salary"]== ">50K") & (df["native-country"]=="Iran")]["native-country"].value_counts()/ df[(df["native-country"]=="Iran")]["native-country"].value_counts() * 100,1))
